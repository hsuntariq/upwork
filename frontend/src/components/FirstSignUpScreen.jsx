    ...
    return (
        <>
            ...
            <div className="flex gap-5  justify-center items-center flex-col mx-auto  w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] xl:w-[35%]">
                ...
                <button disabled={!role} className={`${role ? 'bg-green-600 text-white cursor-pointer' : 'bg-gray-300 text-black cursor-not-allowed'} px-5 font-semibold py-3 rounded-md `}>
